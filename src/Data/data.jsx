export const data = [
  ...
  {
    Questions:
      'Which of the following combinations is used for "Change Case" ?',
    A: "Alt+F3",
    B: "Alt+C",
    C: "Shift+F3",
    D: "None of the above",
  ...
  {
    Questions:
      "How do you convert your presentation in to compressed package ?",
  ...
  {
    Questions:
      "What database objects do reports get the information to display",
    A: "Queries",
    B: "Tables",
    C: "both 1 and2",
    D: "none of the above",
  ...
  {
    Questions:
      "Access provide a graphical tool known as ___________ for designing complex expressions forQueries",
    A: "Query Builder",
    B: "Form Builder",
    C: "Report Builder",
  ...
  {
    Questions:
      "__________Query prompts the users for the criteria on which data will be retrieved.",
    A: "Select",
    B: "SQL",
    C: "Parameter",
    D: "Action",
  ...
  {
    Questions:
      "_________ is used to display summarised values of both the rows and columns in theQuery.",
    A: "Crosstab",
    B: "Select",
    C: "SQL",
    D: "Parameter",
  ...
  {
    Questions:
      "To create a selectQuery from the selected fields the following option is used",
    A: "Design view",
  ...
  {
    Questions:
      "To delete all the fields from theQuery which one of the option is selected from Edit Menu.",
    A: "Delete",
    B: "Delete all",
    C: "Clear",
    D: "Clear Grid",
  ...
  {
    Questions:
      "In a CrosstabQuery ,you cannot set the ______ orders according to your requirements.",
    A: "Row",
    B: "Coulmn",
    C: "Both a and b",
    D: "None of the above",
  ...
  {
    Questions:
      "Max. No. o0f table&amp; objects in a database is allowed by Access",
    A: "-32767",
    B: "32767",
    C: "32768",
    D: "255",
  ...
  {
    Questions:
      "One of the following statements about Excel ranges is incorrect",
  ...
  {
    Questions:
      "Consists of an user ID, followed by an @ sign and a domain name",
    A: "Postal Address",
    B: "E-Mail Address",
    C: "Phone Number",
    D: "None of the three options",
  ...
  {
    Questions:
      "Through a computer can replace people in dull and routine tasks, yet itlacks",
    A: "initiative",
    B: "originality",
    C: "speed",
    D: "accuracy",
  ...
  {
    Questions:
      "A new technology which provides the ability to create an artificial world and haepeople interact with it is called",
    A: "televirtuality",
    B: "virtual reality",
  ...
  {
    Questions:
      "The attribution of human from orQualities to things such as machines or computers is called",
    A: "cybernetics",
    B: "cybernation",
    C: "artificial intelligence",
    D: "anthropomorphism",
  ...
  {
    Questions:
      "A computer can only do what it is told to but it does it at a very fast speed and with cent percent accuracy. Can you guess the InteligenceQuotient (IQ)of a modern degital computer ?",
    A: "100",
    B: "0",
    C: "60",
    D: "150",
  ...
  {
    Questions:
      "Which of the following does not describe one or more characteristics ofa Computer ?",
    A: "electronics",
    B: "external storege",
    C: "storage program",
  ...
  {
    Questions:
      "A control unit whose binary control variablesare stored in memory is known as",
  ...
  {
    Questions:
      "The main distinguishingfeatures of fifth generatin digital computers will be",
  ...
  {
    Questions:
      "The counting board in which numbers are represented asbeads strung on wires is commonyl called abacus. Bywhat name is it known in Japan",
    A: "Suanpan",
    B: "soroban",
    C: "Napier's beads",
    D: "Suharto",
  ...
  {
    Questions:
      "Which of the following is not an advantage of stored programs ?",
    A: "reliability",
  ...
  {
    Questions:
      "The text justification optionthat prompts the user for two endpoints and the text height so the text is adjusted between the two points at the specified height is",
    A: "Fit",
    B: "Centered",
    C: "Fully centered",
    D: "Right justified",
  ...
  {
    Questions:
      "For the purposes of defining data needs, responsibility area is",
    A: "marketing",
    B: "administration",
    C: "personnel",
    D: "all of the above",
  ...
  {
    Questions:
      "Arithmetic and Logic Unit (ALU) are called the______ of a computer",
    A: "heart",
    B: "master despatcher",
    C: "primary memory",
    D: "all of the above",
  ...
  {
    Questions:
      "Which of the following are used toQuickly accept, store and transfer data and instructions that are being used immediately by the CPU ?",
    A: "microprocessors",
    B: "registers",
    C: "ROM chips",
    D: "data buses",
  ...
  {
    Questions:
      "To logical data structure with a one-to-many relationship is a:",
    A: "network",
    B: "tree",
    C: "chain",
    D: "relational",
  ...
  {
    Questions:
      "Thedata base administrator is, in effect, the coordinatror between the ……and the…….",
    A: "DBMS; data base",
    B: "Application program, data base",
    C: "Data base; users",
    D: "Application programs; users",
  ...
  {
    Questions:
      "Which of the following contains a complete record of all activitythat affectted the contents of a data bae during a ceertain perido of time?",
    A: "reprot writer",
    B: "query language",
  ...
  {
    Questions:
      "Which of the following is a data base administrator's function?",
    A: "data base design",
  ...
  {
    Questions:
      "A computer in which data is representedby a continuously variable physicalQuantity is",
    A: "Digital computer",
    B: "analog computer",
    C: "Hybrid computer",
  ...
  {
    Questions:
      "which of the following setup options cannnot be set in the page setup dialog box",
    A: "printer selection",
  ...
  {
    Questions:
      "when you use the fill effects in the format data series dialog box you cannnot",
